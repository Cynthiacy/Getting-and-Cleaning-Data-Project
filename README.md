...
This is a repository for the codes written for the Getting and Cleaning Data Coursera course in Coursera provided by JHU.
...
Use data <- read.table("MeanData.txt") to read the data. This data represents average of each variable for each activity and each subject.
